use crate::c_types::{CVertexAttribDesc, CComponentType};
...
impl VertexAttribDesc {
    pub fn new(binding_num: u32,
        ...
        let actual_stride = if stride_in_bytes == 0 { component_type.byte_size() as u32 * num_components } else { stride_in_bytes } as u32;
        Self { attrib_desc: CVertexAttribDesc {
            binding_num,
            component_type,
            num_components,
